...
# file used to list all entries as lemon entries in the same file 
# Please BE CAREFUL with the namespaces. Before launching the script, have a look to the header file.
# For example <!ENTITY psc "http://www.languagelibrary.eu/owl/simple/psc/pscLemon" > is the namespace for the lemonentries to be saved into.
# If  BASE_ROOT=http://www.languagelibrary.eu"
# and LOC_ROOT=owl/simple
# Then we have that the final namespace psc is "http://www.languagelibrary.eu/owl/simple/psc/pscLemon#" >
# So, use psc as namespace ;)
if len(sys.argv) >2:
...
result_filename = namespace+"/pscLemon" # contains the list of the lemonentries
